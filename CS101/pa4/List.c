...
typedef struct NodeObj{
	...
	// newNode()	
	// Returns reference to new Node Object> Initalizes data, previous and next 
	// Private
...
//-------------------------------Manipulation procedures----------------------
	...
	L->cursorIndex = NULL;
   	...
   	// defined and not at back moving cursorIndex one step
      	if(L->cursorIndex != NULL && L->index != L->length - 1) {
         ...
         // defined and at back cursorIndex becomes null or undefined
      	} else if (L->cursorIndex != NULL && L->index == L->length - 1) {
...
//---------------------------------------Other Methods-------------------------------------------------------
    ...
    // The cursor in the new list is undefined, regardless the state of cursor in 
    //
    //
    //
    // list
